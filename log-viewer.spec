...
"""
Konfiguracja PyInstallera dla aplikacji Log Viewer.
...
excluded_binaries = {
    # Ciężki rasteryzator programowy Mesa (21.5 MB na Windows)
    "opengl32sw",
...
run_frozen_path = str(repo_root / "run_frozen.py")
...
# Filtrowanie zbędnych plików tłumaczeń Qt (80+ języków) - zostawiamy tylko polski i angielski
a.datas = [
    x
    for x in a.datas
