...
* Dodając nowe teksty w interfejsie użytkownika, należy zaktualizować słowniki tłumaczeń (zarówno w języku polskim jak i angielskim) w pliku `log_viewer/i18n.py`.
